                ...
                <div class="checkout-form">
                    <div class="billing-info__wrapper">
                        ...
                        @if ($address)
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="my-account__assress-list">
                                        <div class="my-account__assress-list-item">
                                ...
                                @if (Session::has('discounts'))
                                    <table class="checkout-totals">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Discount  {{ Session::get('coupon')['type'] == 'fixed' ? '$' . Session::get('coupon')['value'] : Session::get('coupon')['value'] . '%' }}</th>
                                ...
                                @else
                                    ...
                                    <table class="checkout-totals">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>SHIPPING</th>
                                                <td class="right">Free shipping</td>
                                            </tr>
                                            <tr>
                                                <th>VAT</th>
                                                <td class="right">${{ $subtotal * config('cart.tax') / 100 }}</td>
                                            </tr>
                                            <tr>
                                                <th>TOTAL</th>
                                                <td class="text-right">${{ $subtotal + ($subtotal * config('cart.tax') / 100) }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                @endif
