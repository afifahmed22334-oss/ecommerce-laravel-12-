              ...
              <div class="product-single__media" data-media-type="vertical-thumbnail">
                  ...
                  <div class="swiper-container">
                    <div class="swiper-wrapper">
                      ...
                      @foreach (explode(",", $product->images) as $gimg)
                        ...
                        <div class="swiper-slide product-single__image-item">
                            <img loading="lazy" class="h-auto" src="{{ asset('uploads/products/' . $gimg) }}" width="674" height="674"
                                alt="" />
                ...
                <div class="product-single__thumbnail">
                  <div class="swiper-container">
                    ...
                    @foreach (explode(",", $product->images) as $gimg)
                          <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{ asset('uploads/products/thumbnails/' . $gimg) }}" height="104" alt="" /></div>
                    @endforeach
                ...
                @foreach ($rproducts as $rproduct)
                    <div class="swiper-slide product-card">
                        <div class="pc__img-wrapper">
                            ...
                            @if (isset(session('cart')[$rproduct->id]))
                                <a href="{{ route('cart.index') }}" class="btn btn-warning mb-3 pc__atc anim_appear-bottom  position-absolute border-0 text-uppercase fw-medium">Go to cart</a>
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <h6 class="pc__title"><a href="{{ route('shop.show', $rproduct->slug) }}">{{ $rproduct->name }}</a></h6>
