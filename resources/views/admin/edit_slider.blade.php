...
@section('content')
    ...
    <div class="main-content-inner">
        ...
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form action="{{ route('sliders.update', $slider->id) }}" method="POST" class="form-new-product form-style-1"
