        ...
        <section class="contact-us container">
            <div class="mw-930">
                <div class="contact-us__form">
                    <form action="{{ route('contact_store') }}" name="contact-us-form" class="needs-validation" novalidate="" method="POST">
                        @csrf
                        ...
                        <div class="form-floating my-4">
                            <input type="text" class="form-control" name="phone" placeholder="Phone *" required="" {{ old('phone') }}>
                        ...
                        <div class="form-floating my-4">
                            <input type="email" class="form-control" name="email" placeholder="Email address *" required="" {{ old('email') }}>
